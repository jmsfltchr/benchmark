...
public class GraknOperationFactory extends TransactionalDbOperationFactory<GraknOperation> {
    ...
    @Override
    public GraknOperation newDbOperation(String tracker, long iteration, boolean trace, boolean isWrite) {
        return new GraknOperation(session, logger(), tracker, iteration, trace, isWrite);
    }
}
